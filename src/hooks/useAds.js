    ...
    const fetchPublicAds = useCallback(async ({ page = 1, limit = 50, filters = {} }) => {
        ...
        try {
            ...
            let query = supabase
                ...
                .order('order_index', { referencedTable: 'plan', ascending: true, nullsFirst: false })
                .order('created_at', { ascending: false });
            ...
            if (filters.categoryIds && filters.categoryIds.length > 0) {
                query = query.in('listing_categories.category_id', filters.categoryIds);
            }
